...
import com.patrickbr.saslcompiler.client.exceptions.FunctionNotDefinedException;
import com.patrickbr.saslcompiler.client.exceptions.ReduceException;
import com.patrickbr.saslcompiler.client.exceptions.TimeoutException;
import com.patrickbr.saslcompiler.client.exceptions.TypeMismatchException;
...
public abstract class ReductionMachine {
	...
	public static Node reduce(Node tree) throws ReduceException {
		return reduce(tree, 10000);
	}
	
	public static Node reduce(Node tree, int maxtime) throws ReduceException {
		...
		while (!nodeStack.peek().isPrintable()) {
			try {
				...
				throw new ReduceException("Incompatible type.");
			}
		}
