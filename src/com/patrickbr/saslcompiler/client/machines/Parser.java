...
import com.patrickbr.saslcompiler.client.tokens.TokenBool;
import com.patrickbr.saslcompiler.client.tokens.TokenEOF;
import com.patrickbr.saslcompiler.client.tokens.TokenID;
import com.patrickbr.saslcompiler.client.tokens.TokenSymbol;
import com.patrickbr.saslcompiler.client.tokens.TokenNum;
import com.patrickbr.saslcompiler.client.tokens.TokenString;
import com.patrickbr.saslcompiler.client.tokens.Token;
import com.patrickbr.saslcompiler.client.tokens.TokenSymbol.tokenType;
...
public class Parser {
	 ...
	 */	
	private Node evSystem() throws ParseException  {
	...
	private void evFuncDef() throws ParseException  {
	...
	private void evIncludeFuncDef() throws ParseException  {
		definitions.add(evDef());
	...
	private String evName() throws ParseException  {
	...
	private Node evAbstraction() throws ParseException  {
	...
	private Node evExpr() throws ParseException  {
	...
	private Node evListExpr() throws ParseException {
	...
	private Node evListExprStrich() throws ParseException {
	...
	private Node evOpExpr() throws ParseException {
	...
	private Node evCompar() throws ParseException {
		Node add = evAdd();
		Node relop= null;
	...
	private Node evComb() throws ParseException {
	...
	private Node evList() throws ParseException {
	 ...
	 */
	private boolean nextTokenIsSymbolTokenType(TokenSymbol.tokenType type) {
		if (moreTokens()){
	 ...
	 */
	private boolean nextTokenIsNumToken() {
		if (moreTokens()){
			Token test=this.getLookAhead();
	 ...
	 */	
	private boolean nextTokenIsBoolToken() {
		if (moreTokens()){
			Token test=this.getLookAhead();
	 ...
	 */	
	private boolean nextTokenIsStringToken() {
		if (moreTokens()){
			Token test=this.getLookAhead();
	 ...
	 */
	private boolean nextTokenIsIdToken() {
		if (moreTokens()){
			Token test=this.getLookAhead();
